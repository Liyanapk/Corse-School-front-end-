...
export default function SendEmail() {
  return (
    <div id="contact" className="flex flex-col lg:flex-row items-center justify-center gap-14 lg:gap-52 bg-gradient-to-r from-gray-200 via-pink-200 to-gray-200 p-12">
