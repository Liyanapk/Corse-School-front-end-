...
const Dashboard = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-100 mt-10 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-7 bg-white rounded-md shadow-lg">
          <h1 className="text-xl md:text-2xl font-bold mb-8 px-4 md:px-6">Dashboard</h1>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 px-4 md:px-6">
